...
void tronMang(int x1[100], int n_x1, int x2[100], int n_x2,int x3[200], int &n_x3){
	n_x3 = n_x1+n_x2; // so luong phan tu cua mang 3 = mang 2+ mang 1
	int i1 = 0;
	int i2 = 0;
	int i3 = 0;
	while(i3< n_x3){ // trong khi vi tri i3 tai mang x3 van < so luong phan tu mang3
	//chay tu i3 => het mang n_x3
		if( (i1 >= n_x1) ){
			x3[i3] = x2[i2];
			i2++;
		}else if(i2 >= n_x2){
